...
struct animation{
      ...
      int frames []; //matrix to show active LEDs
      uint16_t delays []; //milliseconds to hold current frame
...
int Face_blink2 [50][2] 
                    = {{8,3}, {9,3}, {10,3}, {11,3}, {12,3}, {13,3}, {14,3}, {17,3}, {18,3}, {19,3}, {20,3}, {21,3}, {22,3}, {23,3},  // Topline 14
                      ...
                      {666, 0}, {666, 0}, {666, 0}, {666, 0}, {666, 0}, {666, 0}, {666, 0}, {666, 0},                                 //KILL + Buffer 8
                      {666, 0}, {666, 0}, {666, 0}, {666, 0}, {666, 0}, {666, 0}, {666, 0}, {666, 0},                                 //KILL + Buffer 6
                      {666, 0}, {666, 0}, {666, 0}, {666, 0}, {666, 0}, {666, 0}};                                                    //KILL + Buffer 8   
