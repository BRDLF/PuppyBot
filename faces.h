...
int arrayface[7] = {&Face_stare, &Face_blink1, &Face_blink2, &Face_happy, &Face_blush1, &Face_blush2, &Face_blush3}; //old method of indexing frames, takes up a ton of memory for some reason?
